package com.yuling.puppy.config.apidoc;

import com.yuling.puppy.config.Constants;
import com.yuling.puppy.config.JHipsterProperties;
...
public class SupplierSwaggerConfiguration {

    private final Logger log = LoggerFactory.getLogger(SupplierSwaggerConfiguration.class);

    public static final String DEFAULT_INCLUDE_PATTERN = "/supplier/.*";
    ...
    public Docket swaggerSpringfoxDocket(JHipsterProperties jHipsterProperties) {
        log.debug("Starting Supplier Swagger");
